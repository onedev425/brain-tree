            ...
            <aside class="w-full bg-white beautify-scrollbar text-black overflow-scroll">
                <div class="p-3">
                    ...
                    @isset ($menu)
                        ...
                        <form id="logout_form" action="{{route('logout')}}" class="w-full" method="POST">
                            @csrf
                            <button name="logout_button" class="flex w-full text-dark gap-2 px-4 mt-7 text-center text-lg font-medium p-3 px-4 my-0 rounded-xl hover:bg-red-100">
                                ...
                                <p class="text-lg px-1">{{ __('Log out') }}</p>
                            </button>
                        </form>
                    @endif
                </div>
