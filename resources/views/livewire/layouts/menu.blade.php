<div class="w-full absolute text-center -mt-16 lg:hidden">
...
<nav class="hidden lg:block lg:sticky inset-0 w-full h-full lg:sidebar-expand lg:-mt-14 lg:-mt-24 lg:ml-10 lg:ml-14 flex duration-250 transition-all z-40" :class="{'d-block absolute' : menuOpen == true}">
    <div class="card mt-0 sm:p-10 lg:p-4">
        <div class="card-body">
            <button role="button" class="text-2xl mx-3 text-gray-400 float-right border border-1 rounded-full px-4 py-2 shadow -mt-2 -mr-4 lg:hidden" @click="menuOpen = !menuOpen">
                <p class="sr-only">Menu</p>
    ...
    <script>
        ...
        $('button[name=logout_button]').on('click', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('form#logout_form input[name=_token]').val(response.token);
