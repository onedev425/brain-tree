<form action="{{ route('register') }}" method="POST" class="w-full">
    <div class="text-center mb-7">
        <div class="inline-flex space-x-4">
            <label class="bg-purple-300 p-4 rounded-lg flex items-center">
    ...
    <div class="flex">
        <div class="w-1/2 px-3 mb-3">
            <label for="" class="text-white font-medium px-1 block mb-3">User name *</label>
            <div class="block">
    ...
    <div class="flex mt-4">
        ...
        <div class="w-1/2 px-3 mb-3">
            <label for="" class="text-white font-medium px-1 block mb-3">Confirm password *</label>
            <div class="block">
