<button @class(["$class p-2 rounded-md hover:bg-green-500 hover:text-white"] )>
    <svg xmlns="http://www.w3.org/2000/svg" width="21.215" height="21.398" viewBox="0 0 21.215 21.398">
